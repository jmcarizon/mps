...
$(objects[i]).addClass('embed-responsive-item');
	...
	function modal(button, modal) {
		$(document).on('click', button, function(){
			...
			if (el.is(':visible')) {
				...
				el.siblings().addClass('blur');
			}
		})
	}

	// BUTTON, MODAL CONTAINER
	modal(".btn_addmovie", ".modal_addMovie");
	// modal(".btn_edit", ".modal_updateMovie");
	...
	$('.btn_updatemovie').click(function() {
		$('.editThis').toggleClass('showThis');
		$('.table_header div, .table_body div').toggleClass('expand');
	});

	$('.btn_edit').click(function() {
		$(this).toggleClass('submitThis');
		$('.submit_btn').toggleClass('submitThis');
		$('.form').toggleClass('notActive');
	});
